...
Алгоритм работы с нейронной сетью, состоящей из нескольких машин опорных векторов:
...
/*! \en \brief TRANSLATE \ru \brief Описатель нейронной сети, состоящей из нескольких машин опорных векторов \endlang */
