...
\en \brief (Pseudo) random number generation \ru \brief Генерация (псевдо) случайных чисел \endlang
...
/*! \en \brief (Pseudo) random number generator \ru \brief Датчики (псевдо) случайных чисел \endlang */
...
/*! \en \brief (Pseudo) random number distribution \ru \brief Распределения (псевдо) случайных чисел \endlang */
...
/*! \en \brief Descriptor for (pseudo) random number generator \ru \brief Описатель датчика (псевдо) случайных чисел \endlang */
