...
\ru
	...
	В любой матрице, описывающей граф, номер строки суть есть индекс вершины графа - исхода соответствующего ребра, номер столбца, соответственно - индекс вершины графа - захода соответствующего ребра.
